...
void D3D11ElementAttributeClass::SetZZZObjectType2() {
	...
	NORMAL.Format = L"R16G16B16A16_FLOAT";
	...
	TANGENT.Format = L"R16G16B16A16_FLOAT";
	...
	TEXCOORD.ExtractVBFile = L"vb0";
	TEXCOORD.ExtractTechnique = L"trianglelist";
	TEXCOORD.Category = L"Position";
	...
	TEXCOORD1.ExtractVBFile = L"vb0";
	TEXCOORD1.ExtractTechnique = L"trianglelist";
	TEXCOORD1.Category = L"Position";
	...
	this->orderedFullElementList = { L"POSITION",L"NORMAL",L"TANGENT",L"TEXCOORD",L"TEXCOORD1" };
