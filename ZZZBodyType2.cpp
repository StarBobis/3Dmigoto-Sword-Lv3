...
void D3D11ElementAttributeClass::SetZZZBodyType2() {
	...
	reserve10Texcoord = true;
	reserve10Normal = true;
	reserve10Position = true;

	this->ifUseMaxStrideTexcoordIfCannotFindPerfect = true;
	...
	D3D11Element TEXCOORD2;
	TEXCOORD2.SemanticName = L"TEXCOORD";
	TEXCOORD2.ExtractSemanticName = L"TEXCOORD2";
	TEXCOORD2.SemanticIndex = L"2";
	TEXCOORD2.OutputSemanticIndex = L"2";
	TEXCOORD2.Format = L"R16G16_FLOAT";
	TEXCOORD2.InputSlot = L"0";
	TEXCOORD2.InputSlotClass = L"per-vertex";
	TEXCOORD2.InstanceDataStepRate = L"0";
	TEXCOORD2.ByteWidth = 4;
	TEXCOORD2.ExtractVBFile = L"vb1";
	TEXCOORD2.ExtractTechnique = L"pointlist";
	TEXCOORD2.Category = L"Texcoord";
	this->ElementNameD3D11ElementMap[L"TEXCOORD2"] = TEXCOORD2;

	D3D11Element TEXCOORD3;
	TEXCOORD3.SemanticName = L"TEXCOORD";
	TEXCOORD3.ExtractSemanticName = L"TEXCOORD3";
	TEXCOORD3.SemanticIndex = L"3";
	TEXCOORD3.OutputSemanticIndex = L"3";
	TEXCOORD3.Format = L"R16G16_FLOAT";
	TEXCOORD3.InputSlot = L"0";
	TEXCOORD3.InputSlotClass = L"per-vertex";
	TEXCOORD3.InstanceDataStepRate = L"0";
	TEXCOORD3.ByteWidth = 4;
	TEXCOORD3.ExtractVBFile = L"vb1";
	TEXCOORD3.ExtractTechnique = L"pointlist";
	TEXCOORD3.Category = L"Texcoord";
	this->ElementNameD3D11ElementMap[L"TEXCOORD3"] = TEXCOORD3;
	...
	BLENDINDICES.Format = L"R32G32B32A32_UINT";
	...
	this->orderedFullElementList = { L"POSITION",L"NORMAL",L"TANGENT",L"COLOR",L"TEXCOORD",L"TEXCOORD1",L"TEXCOORD2",L"TEXCOORD3",L"BLENDWEIGHTS",L"BLENDINDICES" };
