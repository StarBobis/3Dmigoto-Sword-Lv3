...
void D3D11ElementAttributeClass::SetGIObject() {
	...
	NORMAL.Format = L"R8G8B8A8_SNORM";
	...
	TANGENT.Format = L"R8G8B8A8_SNORM";
	...
	COLOR.ByteWidth = 4;
	COLOR.ExtractVBFile = L"vb0";
	COLOR.ExtractTechnique = L"trianglelist";
	COLOR.Category = L"Position";
	...
	this->orderedFullElementList = { L"POSITION",L"NORMAL",L"COLOR",L"TEXCOORD",L"TEXCOORD1",L"TANGENT" };
