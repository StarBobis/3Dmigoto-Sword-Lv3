...
void D3D11ElementAttributeClass::SetHI3Body2() {
	this->CategoryDrawCategoryMap[L"Position"] = L"Blend";
	this->CategoryDrawCategoryMap[L"Texcoord"] = L"Texcoord";
	this->CategoryDrawCategoryMap[L"Blend"] = L"Blend";
	...
	this->orderedFullElementList = { L"POSITION",L"NORMAL",L"COLOR",L"TANGENT",L"TEXCOORD",L"TEXCOORD1",L"BLENDWEIGHT",L"BLENDINDICES" };
